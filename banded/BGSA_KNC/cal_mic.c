...
#pragma omp parallel for default(none) num_threads(mic_threads)\
    ...
    shared( ref_len,read_len,ref_start, ref_end, content, align_results, preprocess_reads, loop_num, loop_num_temp, word_num, dvdh_bit_mem, chunk_read_num, rest_read_num, threshold) \
...
void cal_on_mic() {
...

    {
        ...
        offload_dvdh_size = mic_threads * dvdh_len;
